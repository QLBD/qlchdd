...
public class BaoHanhController {
    ...
    public void themBaoHanh(BaoHanh baoHanh, iMessageView callBack) {
        ...
        long bh1 = baoHanh.getSerial();
        long bh2;
        for (BaoHanh bh : list) {
            if (baoHanh.getSanpham().getMaSp() == bh.getSanpham().getMaSp() && baoHanh.getHoadonban().getSohdBan() == bh.getHoadonban().getSohdBan()) {
                bh2 = bh.getSerial();
                if (bh1 == bh2) {
                    if(bh.getTinhtrang() != 2){
